...
A 64-bit build system is strongly recommended for asn2c operation.

A working C99 compiler is required to compile asn2c itself,
such as gcc-4.x or clang-3.4. The asn2c compiler produces C90-compatible code,
...
## To compile asn2c-generated code
