...
EtsiTs103097Certificate_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
	...
	// Tipo con vincolo: EtsiTs103097Certificate
	// Accesso alla struttura tipizzata
	const EtsiTs103097Certificate_t *typed_struct = (const EtsiTs103097Certificate_t *)sptr;
	// Memorizzazione del tipo per uso successivo
	const char *constraint_type = "EtsiTs103097Certificate";
...
static asn_per_constraints_t asn_PER_type_EtsiTs103097Certificate_constr_1 CC_NOTUSED = {
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_EtsiTs103097Certificate_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
