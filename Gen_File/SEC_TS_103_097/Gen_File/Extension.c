...
static asn_TYPE_member_t asn_MBR_content_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EtsiTs103097HeaderInfoExtensions__content, EtsiTs102941CrlRequest),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EtsiTs103097HeaderInfoExtensions__content, EtsiTs102941DeltaCtlRequest),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
