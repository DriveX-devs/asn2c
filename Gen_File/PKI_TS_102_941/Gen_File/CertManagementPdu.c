...
asn_TYPE_member_t asn_MBR_CertManagementPdu_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CertManagementPdu, compositeCrl),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CertManagementPdu, certificateChain),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CertManagementPdu, multiSignedCtl),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_MultiSignedCtl,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CertManagementPdu, tbsCtlSignature),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CertManagementPdu, infoStatus),
...
asn_TYPE_descriptor_t asn_DEF_CertManagementPdu = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_CertManagementPdu_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_CertManagementPdu_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
