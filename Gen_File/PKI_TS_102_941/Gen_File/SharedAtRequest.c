...
memb_requestedSubjectAttributes_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
	...
	// Tipo con vincolo: requestedSubjectAttributes
	// Accesso alla struttura tipizzata
	const requestedSubjectAttributes_t *typed_struct = (const requestedSubjectAttributes_t *)sptr;
	// Memorizzazione del tipo per uso successivo
	const char *constraint_type = "requestedSubjectAttributes";
