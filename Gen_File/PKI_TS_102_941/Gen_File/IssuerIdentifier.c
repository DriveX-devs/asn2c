...
asn_TYPE_member_t asn_MBR_IssuerIdentifier_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct IssuerIdentifier, sha256AndDigest),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct IssuerIdentifier, self),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct IssuerIdentifier, sha384AndDigest),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct IssuerIdentifier, sm3AndDigest),
