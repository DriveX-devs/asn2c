...
asn_TYPE_member_t asn_MBR_EcSignature_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EcSignature, encryptedEcSignature),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_EtsiTs103097Data_Encrypted_93P0,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EcSignature, ecSignature),
