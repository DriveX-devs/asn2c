 ...
 * 	found in "preprocessed_temp/Ieee1609Dot2Dot1EcaEeInterface.asn"
...
memb_tbsCert_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
	...
	// Verifica del componente: id (optional: no)
	// Vincoli aggiuntivi sul componente id
	    /* Componente 'id' non trovato nella definizione */
	...
	/* Component appPermissions is mandatory, cannot be absent */
	ASN__CTFAIL(app_key, td, sptr, "%s: Mandatory component 'appPermissions' cannot be absent", td->name);
	return -1;
	...
	/* Component certRequestPermissions is mandatory, presence is implicit */
	// Verifica del componente: verifyKeyIndicator (optional: no)
	// Vincoli aggiuntivi sul componente verifyKeyIndicator
	    /* Componente 'verifyKeyIndicator' non trovato nella definizione */
...
asn_TYPE_member_t asn_MBR_EeEcaCertRequest_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EeEcaCertRequest, tbsCert),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_tbsCert_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_tbsCert_constr_5,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
