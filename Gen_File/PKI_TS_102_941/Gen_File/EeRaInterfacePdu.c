...
asn_TYPE_member_t asn_MBR_EeRaInterfacePdu_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EeRaInterfacePdu, eeRaCertRequest),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EeRaInterfacePdu, raEeCertAck),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EeRaInterfacePdu, raEeCertInfo),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EeRaInterfacePdu, eeRaDownloadRequest),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EeRaInterfacePdu, eeRaSuccessorEnrollmentCertRequest),
