...
asn_TYPE_member_t asn_MBR_LanePositionOptions_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LanePositionOptions, simplelanePosition),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LanePositionOptions, simpleLaneType),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LanePositionOptions, detailedlanePosition),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LanePositionOptions, lanePositionWithLateralDetails),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LanePositionOptions, trafficIslandPosition),
