...
asn_TYPE_member_t asn_MBR_PathDeltaTimeChoice_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PathDeltaTimeChoice, deltaTimeHighPrecision),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PathDeltaTimeChoice, deltaTimeBigRange),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PathDeltaTimeChoice, deltaTimeMidRange),
