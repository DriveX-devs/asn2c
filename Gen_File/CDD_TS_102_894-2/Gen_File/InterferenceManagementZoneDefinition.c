...
memb_interferenceManagementZoneShape_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
	...
	// Tipo con vincolo: interferenceManagementZoneShape
	// Accesso alla struttura tipizzata
	const interferenceManagementZoneShape_t *typed_struct = (const interferenceManagementZoneShape_t *)sptr;
	// Memorizzazione del tipo per uso successivo
	const char *constraint_type = "interferenceManagementZoneShape";
