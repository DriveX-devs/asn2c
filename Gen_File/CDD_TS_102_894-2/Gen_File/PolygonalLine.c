...
static asn_per_constraints_t asn_PER_type_PolygonalLine_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  2,  2,  0,  3 }	/* (0..3,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static asn_TYPE_member_t asn_MBR_PolygonalLine_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PolygonalLine, deltaPositions),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PolygonalLine, deltaPositionsWithAltitude),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PolygonalLine, absolutePositions),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PolygonalLine, absolutePositionsWithAltitude),
...
static asn_CHOICE_specifics_t asn_SPC_PolygonalLine_specs_1 = {
