...
memb_groupSubClass_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
	...
	// Tipo con vincolo: groupSubClass
	// Accesso alla struttura tipizzata
	const groupSubClass_t *typed_struct = (const groupSubClass_t *)sptr;
	// Memorizzazione del tipo per uso successivo
	const char *constraint_type = "groupSubClass";
	// Verifica del componente: clusterBoundingBoxShape (optional: no)
	/* Component clusterBoundingBoxShape is mandatory, cannot be absent */
	ASN__CTFAIL(app_key, td, sptr, "%s: Mandatory component 'clusterBoundingBoxShape' cannot be absent", td->name);
	return -1;
...
asn_TYPE_member_t asn_MBR_ObjectClass_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ObjectClass, vehicleSubClass),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ObjectClass, vruSubClass),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ObjectClass, groupSubClass),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ObjectClass, otherSubClass),
