...
asn_TYPE_member_t asn_MBR_LoadType_1[] = {
	{ ATF_POINTER, 2, offsetof(struct LoadType, goodsType),
	...
	{ ATF_POINTER, 1, offsetof(struct LoadType, dangerousGoodsType),
...
static const int asn_MAP_LoadType_oms_1[] = { 0, 1 };
...
asn_SEQUENCE_specifics_t asn_SPC_LoadType_specs_1 = {
	...
	asn_MAP_LoadType_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
