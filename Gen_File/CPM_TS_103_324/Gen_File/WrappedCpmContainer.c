...
static asn_TYPE_member_t asn_MBR_containerData_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct WrappedCpmContainer__containerData, OriginatingVehicleContainer),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct WrappedCpmContainer__containerData, OriginatingRsuContainer),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct WrappedCpmContainer__containerData, SensorInformationContainer),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct WrappedCpmContainer__containerData, PerceptionRegionContainer),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct WrappedCpmContainer__containerData, PerceivedObjectContainer),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
