 ...
 * 	found in "preprocessed_temp/CPM-PerceivedObjectContainer.asn"
...
memb_PerceivedObject_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
	...
	// Verifica del componente: objectId (optional: no)
	/* Component objectId is mandatory, presence is implicit */
