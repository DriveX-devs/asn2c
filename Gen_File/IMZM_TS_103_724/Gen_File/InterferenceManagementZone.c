...
asn_TYPE_member_t asn_MBR_InterferenceManagementZone_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct InterferenceManagementZone, interferenceManagementInfo),
...
static const asn_TYPE_tag2member_t asn_MAP_InterferenceManagementZone_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* interferenceManagementInfo */
};
