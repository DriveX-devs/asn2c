...
asn_TYPE_member_t asn_MBR_SpecialVehicleContainer_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SpecialVehicleContainer, publicTransportContainer),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SpecialVehicleContainer, specialTransportContainer),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SpecialVehicleContainer, dangerousGoodsContainer),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SpecialVehicleContainer, roadWorksContainerBasic),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SpecialVehicleContainer, rescueContainer),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SpecialVehicleContainer, emergencyContainer),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SpecialVehicleContainer, safetyCarContainer),
