...
asn_TYPE_member_t asn_MBR_InterferenceManagementZoneShape_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct InterferenceManagementZoneShape, rectangle),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct InterferenceManagementZoneShape, circle),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct InterferenceManagementZoneShape, polygon),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct InterferenceManagementZoneShape, ellipse),
