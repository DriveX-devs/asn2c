...
asn_TYPE_member_t asn_MBR_LaneDataAttribute_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LaneDataAttribute, pathEndPointAngle),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LaneDataAttribute, laneCrownPointCenter),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LaneDataAttribute, laneCrownPointLeft),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LaneDataAttribute, laneCrownPointRight),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LaneDataAttribute, laneAngle),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LaneDataAttribute, speedLimits),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LaneDataAttribute, regional),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_regional_8,
		0,
