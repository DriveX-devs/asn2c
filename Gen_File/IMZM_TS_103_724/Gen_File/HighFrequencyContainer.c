...
asn_TYPE_member_t asn_MBR_HighFrequencyContainer_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct HighFrequencyContainer, basicVehicleContainerHighFrequency),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HighFrequencyContainer, rsuContainerHighFrequency),
