...
asn_TYPE_member_t asn_MBR_NonIslandLanePosition_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NonIslandLanePosition, offRoadLanePosition),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NonIslandLanePosition, vehicularLanePosition),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NonIslandLanePosition, mapPosition),
