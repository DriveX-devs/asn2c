...
asn_TYPE_member_t asn_MBR_VruProfileAndSubprofile_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct VruProfileAndSubprofile, pedestrian),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct VruProfileAndSubprofile, bicyclist),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct VruProfileAndSubprofile, motorcylist),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct VruProfileAndSubprofile, animal),
