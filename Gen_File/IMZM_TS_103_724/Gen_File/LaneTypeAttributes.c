...
asn_TYPE_member_t asn_MBR_LaneTypeAttributes_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LaneTypeAttributes, vehicle),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LaneTypeAttributes, crosswalk),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LaneTypeAttributes, bikeLane),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LaneTypeAttributes, sidewalk),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LaneTypeAttributes, median),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LaneTypeAttributes, striping),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LaneTypeAttributes, trackedVehicle),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LaneTypeAttributes, parking),
