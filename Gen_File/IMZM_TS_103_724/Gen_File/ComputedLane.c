...
static asn_TYPE_member_t asn_MBR_offsetXaxis_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ComputedLane__offsetXaxis, small),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ComputedLane__offsetXaxis, large),
...
static asn_TYPE_member_t asn_MBR_offsetYaxis_6[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ComputedLane__offsetYaxis, small),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_DrivenLineOffsetSm,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ComputedLane__offsetYaxis, large),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_DrivenLineOffsetLg,
		0,
