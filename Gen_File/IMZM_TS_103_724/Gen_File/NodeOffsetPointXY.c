...
asn_TYPE_member_t asn_MBR_NodeOffsetPointXY_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NodeOffsetPointXY, node_XY1),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NodeOffsetPointXY, node_XY2),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NodeOffsetPointXY, node_XY3),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NodeOffsetPointXY, node_XY4),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NodeOffsetPointXY, node_XY5),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NodeOffsetPointXY, node_XY6),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NodeOffsetPointXY, node_LatLon),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NodeOffsetPointXY, regional),
