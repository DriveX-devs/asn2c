...
static asn_TYPE_member_t asn_MBR_encoding_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EXTERNAL__encoding, single_ASN1_type),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EXTERNAL__encoding, octet_aligned),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EXTERNAL__encoding, arbitrary),
