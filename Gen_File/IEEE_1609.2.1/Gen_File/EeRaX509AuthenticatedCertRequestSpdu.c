...
EeRaX509AuthenticatedCertRequestSpdu_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
	...
	// Tipo con vincolo: EeRaX509AuthenticatedCertRequestSpdu
	// Accesso alla struttura tipizzata
	const EeRaX509AuthenticatedCertRequestSpdu_t *typed_struct = (const EeRaX509AuthenticatedCertRequestSpdu_t *)sptr;
	// Memorizzazione del tipo per uso successivo
	const char *constraint_type = "EeRaX509AuthenticatedCertRequestSpdu";
...
/*
 * This type is implemented using Ieee1609Dot2Data_Encrypted_276P2,
