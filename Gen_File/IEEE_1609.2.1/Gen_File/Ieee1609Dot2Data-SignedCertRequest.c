...
Ieee1609Dot2Data_SignedCertRequest_290P0_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
	...
	// Tipo con vincolo: Ieee1609Dot2Data_SignedCertRequest
	// Accesso alla struttura tipizzata
	const Ieee1609Dot2Data_SignedCertRequest_t *typed_struct = (const Ieee1609Dot2Data_SignedCertRequest_t *)sptr;
	// Memorizzazione del tipo per uso successivo
	const char *constraint_type = "Ieee1609Dot2Data_SignedCertRequest";
...
asn_per_constraints_t asn_PER_type_Ieee1609Dot2Data_SignedCertRequest_290P0_constr_1 CC_NOTUSED = {
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_Ieee1609Dot2Data_SignedCertRequest_290P1_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_Ieee1609Dot2Data_SignedCertRequest_290P0_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_Ieee1609Dot2Data_SignedCertRequest_290P1_constr_2,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
