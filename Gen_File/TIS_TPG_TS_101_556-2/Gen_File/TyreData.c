...
static asn_TYPE_member_t asn_MBR_currentTyrePressure_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TyreData__currentTyrePressure, tyrePressureValue),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TyreData__currentTyrePressure, unavailable),
...
static asn_TYPE_member_t asn_MBR_tyreSidewallInformation_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TyreData__tyreSidewallInformation, tyreSidewallInformationValue),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TyreData__tyreSidewallInformation, unavailable),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
...
static asn_TYPE_member_t asn_MBR_currentInsideAirTemperature_8[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TyreData__currentInsideAirTemperature, tyreAirTemperatureValue),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TyreData__currentInsideAirTemperature, unavailable),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
...
static asn_TYPE_member_t asn_MBR_recommendedTyrePressure_11[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TyreData__recommendedTyrePressure, axlePlacardPressureValue),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TyreData__recommendedTyrePressure, unavailable),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
...
static asn_TYPE_member_t asn_MBR_tin_14[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TyreData__tin, tinValue),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_TIN,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TyreData__tin, unavailable),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
...
static asn_TYPE_member_t asn_MBR_sensorState_17[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TyreData__sensorState, sensorStateValue),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_SensorState,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TyreData__sensorState, unavailable),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
