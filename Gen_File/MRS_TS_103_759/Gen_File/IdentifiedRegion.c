...
asn_TYPE_member_t asn_MBR_IdentifiedRegion_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct IdentifiedRegion, countryOnly),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct IdentifiedRegion, countryAndRegions),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct IdentifiedRegion, countryAndSubregions),
