...
asn_TYPE_member_t asn_MBR_RecipientInfo_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RecipientInfo, pskRecipInfo),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RecipientInfo, symmRecipInfo),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RecipientInfo, certRecipInfo),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RecipientInfo, signedDataRecipInfo),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RecipientInfo, rekRecipInfo),
