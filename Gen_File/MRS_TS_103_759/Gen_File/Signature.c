...
asn_TYPE_member_t asn_MBR_Signature_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Signature, ecdsaNistP256Signature),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Signature, ecdsaBrainpoolP256r1Signature),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Signature, ecdsaBrainpoolP384r1Signature),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Signature, ecdsaNistP384Signature),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Signature, sm2Signature),
