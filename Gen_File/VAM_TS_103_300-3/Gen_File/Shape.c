...
asn_TYPE_member_t asn_MBR_Shape_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Shape, rectangular),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Shape, circular),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Shape, polygonal),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Shape, elliptical),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Shape, radial),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Shape, radialShapes),
