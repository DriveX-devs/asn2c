...
asn_TYPE_member_t asn_MBR_Duration_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Duration, microseconds),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Duration, milliseconds),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Duration, seconds),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Duration, minutes),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Duration, hours),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Duration, sixtyHours),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Duration, years),
