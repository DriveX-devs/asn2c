...
asn_TYPE_member_t asn_MBR_SignerIdentifier_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SignerIdentifier, digest),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SignerIdentifier, certificate),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SignerIdentifier, self),
