...
typedef struct asn1p_constraint_s {
	...
	void *pattern_data;  // Per memorizzare il pattern compilato
} asn1p_constraint_t;
...
int asn1p_validate_pattern(const char *value, const asn1p_constraint_t *ct);
void asn1p_pattern_free(asn1p_constraint_t *ct);
